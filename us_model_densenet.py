...
for iteration in range(0, 10):
    ...
    train_name = "./test_loss/densenet_trainpreds_100epochs_loss_iteration" + str(iteration) + ".csv"
    val_name = "./test_loss/densenet_valpreds_100epochs_loss_iteration" + str(iteration) + ".csv"
    ...
    #             'loss': criterion,
    #         }, "./new_trained_models/densenet_100epochs_v2.torch")


    # print(val_losses_plot)

    # plt.plot([i for i in range(0, EPOCHS)], val_losses_plot)
    # plt.savefig(("./new_loss_plots/densenet_100epochs_v2.png"))